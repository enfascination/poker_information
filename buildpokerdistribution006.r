...
print("PS 1000")
bootstrap_distributions_to_file("~/projecto_staid/poker_information/distrPS1000_2.csv", reps, file_PS_1000)
print("PS 0600")
bootstrap_distributions_to_file("~/projecto_staid/poker_information/distrPS0600_2.csv", reps, file_PS_0600)
print("PS 0400")
bootstrap_distributions_to_file("~/projecto_staid/poker_information/distrPS0400_2.csv", reps, file_PS_0400)
print("PS 0200")
bootstrap_distributions_to_file("~/projecto_staid/poker_information/distrPS0200_2.csv", reps, file_PS_0200)
print("PS 0100")
bootstrap_distributions_to_file("~/projecto_staid/poker_information/distrPS0100_2.csv", reps, file_PS_0100)
print("PS 0050")
bootstrap_distributions_to_file("~/projecto_staid/poker_information/distrPS0050_2.csv", reps, file_PS_0050)
print("PS 0025")
### new version of code shifted skill code up by own over everything.  must correct it at the right place in the pipeline
# raw25 <- fread("~/projecto_staid/poker_information/distrPS0025_4.csv")
# raw25$skil1 <- raw25$skil1+1
# raw25$skil2 <- raw25$skil2+1
# setnames(raw25, "V1", "")
# write.table(raw25, file="~/projecto_staid/poker_information/distrPS0025_4_tweak.csv", row.names=F, sep=',')
bootstrap_distributions_to_file("~/projecto_staid/poker_information/distrPS0025_4_tweak.csv", reps, file_PS_0025)
...
#increment_me <- "031excludeunobserved"
increment_me <- "032_100_noante_showdown"
