...
class Absolute(HandHistoryConverter):
    ...
    def determineGameType(self, handText):
        ...
        if not m:
            failtext = "passed nothing"
            if self.re_GameInfo2.search(handText): failtext = "7 lines"
            elif self.re_GameInfo3.search(handText): failtext = "6 lines"
            elif self.re_GameInfo4.search(handText): failtext = "5 lines"
            elif self.re_GameInfo5.search(handText): failtext = "4 lines"
            elif self.re_GameInfo6.search(handText): failtext = "3 lines"
            elif self.re_GameInfo7.search(handText): failtext = "2 lines"
            tmp = handText[0:200]
            log.error(_("AbsoluteToFpdb.determineGameType: %s: '%s'") % (failtext, tmp))
    ...
    def readHandInfo(self, hand):
        ...
        ### seth ruined times to make the code work right XXX
